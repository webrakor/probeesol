...
const AdvantagesSection = () => {
  ...
  const scrollToAbout = () => {
    // Navigate to /about and pass state to scroll
    navigate('/about', { state: { scrollToSection: true } });
  };
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative flex justify-center md:justify-start">
          ...
          <div className="relative w-[90%] md:w-[480px] lg:w-[630px] rounded-2xl overflow-hidden shadow-xl border border-gray-200 dark:border-gray-800 z-10">
            <img
              src="https://plus.unsplash.com/premium_photo-1661693870771-dbbd8b95b2b1?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0"
        ...
        <div>
          ...
          <button 
            className="px-8 py-3 bg-[#3b82f6] text-white rounded-lg font-semibold shadow-md hover:bg-[#2563eb] transition"
